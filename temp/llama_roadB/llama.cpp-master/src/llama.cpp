...
static std::pair<int, llama_model *> llama_model_load(struct gguf_context * metadata, llama_model_set_tensor_data_t set_tensor_data, void * set_tensor_data_ud,
    ...
    try {
        ...
        // CGC expert-cache: pass budget to loader and set path
        ...
        // CGC expert-cache: init after index is built
        if (params.expert_cache_bytes > 0 && !model->expert_index.empty()) {
            model->expert_cache = llama_expert_cache_init(model, params.expert_cache_bytes);
