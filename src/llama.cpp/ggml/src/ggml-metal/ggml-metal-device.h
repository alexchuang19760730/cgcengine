...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_cgc_pool_row    (ggml_metal_library_t lib);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_id_down_combine (ggml_metal_library_t lib, const struct ggml_tensor * op);
