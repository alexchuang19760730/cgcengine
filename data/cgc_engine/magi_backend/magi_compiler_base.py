...
from cgc_engine.magi_backend.magi_backend import init_backend
from cgc_engine.magi_depyf.timeline import emit_after_dynamo_bytecode_transform, observe_lifecycle
